...
\bibitem{reff1} { D'Angelo H.} Linear systems with variable parameters.  Moscow:  Mashinostroenie, 1974.  
\bibitem{reff2} { Shcheglova A.A.} The solvability of the initial problem for a degenerate linear hybrid system with variable coefficients // Russian Mathematics.  2010. No. 9.  Pp. 49--61.  
\end{thebibliography}
